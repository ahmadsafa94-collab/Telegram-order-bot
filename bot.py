...
async def analyze_receipt_with_ai(context: ContextTypes.DEFAULT_TYPE, items: list,
    ...
    try:
        ...
        content.append({"type": "text", "text": (
            ...
            f"than a small rounding gap).{multi_note}{india_note}{jordan_note}{card_note} "
            ...
            "gap or, for card payments, a normal processing fee), any image doesn't look like a "
            "real payment receipt, the exact same receipt image appears to be submitted more than "
            "once to inflate the total, or the reference/recipient requirement described above "
            "isn't met. "
