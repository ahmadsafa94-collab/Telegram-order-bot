...
ADMIN_LABELS = [
    ...
    A_FIND_ORDER, A_FIND_CUSTOMER, A_CUSTOMER_VIEW,
]
...
def main_menu_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [[BUY_LABEL, MY_SUBS_LABEL], [BASKET_LABEL], [ANNOUNCEMENTS_LABEL], [SUPPORT_LABEL]],
...
def main():
    ...
    app.add_handler(MessageHandler(filters.Text([BUY_LABEL, MY_SUBS_LABEL, BASKET_LABEL, ANNOUNCEMENTS_LABEL, SUPPORT_LABEL]), main_menu_text))
