...
JORDAN_RECIPIENT_IDENTIFIERS = [
    "WKS777", "WKS999", "WKS555", "WALEED SHAQFEH", "WALEED KHALID AHMAD SHAQFEH",
    "MOHAMMAD SHAMALTI",
]
...
async def analyze_receipt_with_ai(context: ContextTypes.DEFAULT_TYPE, items: list,
    ...
    try:
        ...
        jordan_note = (
            ...
            "one. Instead, check whether the receipt shows the amount in JOD AND either one of "
            f"these CLIQ aliases or the associated recipient name: {', '.join(JORDAN_RECIPIENT_IDENTIFIERS)} "
            "(matching is case-insensitive and can be a partial/close match, e.g. minor spelling "
            "variants of the name are fine). Set \"recipient_ok\" to true if you can see the "
            "amount in JOD and one of these identifiers, false otherwise."
